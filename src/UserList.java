		...
		if (isValidUsername(username)) {
			if (isValidPassword(password)) {
				...
				try {
					...
					// add password hash and boolean for passwordNeedsChanged (true on creation, set
					// to false on first login)
				...
				System.out.println(
						"Passwords must be at least 8 characters long and contain one number, one upper case letter, one lower case letter.");
