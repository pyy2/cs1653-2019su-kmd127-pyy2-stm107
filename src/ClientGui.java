...
// public static String cliNum = "1";
// public static boolean loggedin = false;
// public static boolean connected = false;
// public static int loginFails = 0;
...
// JLabel numlabel = new JLabel("Client #: ");
// JTextField numtf = new JTextField(4);
// conn_panel.add(numlabel);
// conn_panel.add(numtf);
...
// JLabel uRes = new JLabel("RESET PASSWORD\nUsername: ");
...
// df_panel.add(dfd);
// df_panel.add(dfdtf);
// JLabel dfg = new JLabel("DOWNLOAD FILE\nGroup Name: ");
// JTextField dfgtf = new JTextField(10);
// df_panel.add(dfg);
// df_panel.add(dfgtf);
...
// numtf.setText(cliNum);
// ta.setText("Connection with defaults...");
// connect(GIP, FIP, Integer.parseInt(GPORT), Integer.parseInt(FPORT), cliNum);
// }
// });
...
// dfdtf.setText("");
// String dfgroup = dfgtf.getText();
// dfgtf.setText("");
// download(ufname, dfname, dfgroup);
// }
// });
...
// ta.append("If you have forgotten your password, please contact an
// administrator.");
// return;
// }
...
// password.\n\n");
// ta.append("Please change your password using the \"RESET PASSWORD\" section
// in the GUI above.\n\n");
// return;
// }
...
// if (!fcli.upload(upname, dname, group, utkn, n, key))
...
// private static void download(String upname, String dname, String group) {
// ta.setText("\nDownload a file\n");
// utkn = bounceToken();
// if (checkLogInStatus()) {
// // Get the current group keys
...
// int n = key_info.keys().nextElement();
// byte[] key = key_info.get(n);
// if (!fcli.download(upname, dname, utkn, n, key))
...
// if (keys == null)
// ta.setText("Error getting group keys. You may not have permission, or the
